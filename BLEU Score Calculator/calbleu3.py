    ...
    for i in range(len(candidate)):
        ...
        for reference in references:
            ...
            for j in range(loop_end):
                ...
                temp_list.append(ng_word)
            ref_counts.append(Counter(temp_list))
        temp_list = []
        ...
        for j in range(loop_end):
            ...
            temp_list.append(cand_word)
        dict_cand = Counter(temp_list)
...
def main():
    ...
    if debug != True:
        ...
        candidate_file = 'candidate-4.txt'
        reference_file = 'reference-4'
